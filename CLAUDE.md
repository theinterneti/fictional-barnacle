...
This project is indexed by GitNexus as **fictional-barnacle** (16892 symbols, 27022 relationships, 121 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
