...
**68 specs** indexed | Generated by `index_specs.py`
...
| S64 | [Generation Serving Profiles](64-generation-serving-profiles.md) | ✅ Approved | 3019 | 16 | 9 | ✅ | ✅ | — |
...
| # | Title | Status | Words | ACs | Gherkin | Stories | Edge Cases | Warnings |
|---|-------|--------|------:|----:|-------:|:-------:|:----------:|----------|
| S14 | [Deployment & Infrastructure](14-deployment.md) | ✅ Approved | 3585 | 34 | 4 | ✅ | ✅ | — |
| S15 | [LF — Langfuse Integration](15-langfuse-integration.md) | 📝 Draft | 3347 | 28 | 5 | ❌ | ✅ | No user stories found, No 'Out of Scope' section |
...
| # | Title | Status | Words | ACs | Gherkin | Stories | Edge Cases | Warnings |
|---|-------|--------|------:|----:|-------:|:-------:|:----------:|----------|
| S50 | [Rate-Limit Budget & Task Prioritization](50-rate-limit-budget.md) | 📝 Draft | 1987 | 6 | 0 | ✅ | ❌ | No edge cases section, No 'Out of Scope' section |
...
- **Total specs**: 68
- **Total words**: 180,569
- **Total acceptance criteria**: 736
- **Specs with warnings**: 32/68
- **Specs with Gherkin scenarios**: 64/68
- **Total Gherkin scenarios**: 349
- **Specs with Given/When/Then**: 63/68
