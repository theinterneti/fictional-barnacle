...
| [S59](59-multiplayer-transport.md) | Multiplayer Transport | WebSocket implementation; session-level sync, presence, reconnection; satisfies S32 NarrativeTransport abstraction |

### v5+ — "Long Vision" (S60–S63, promotes v1 stubs)

| # | Promotes | Description |
|---|----------|-------------|
| S60 _(spec not yet drafted)_ | v1 S19 Crisis Safety | **Gate** for S61. Two-tier crisis detection (pattern match + LLM classifier); out-of-fiction safety response; clinical review required |
| S61 _(spec not yet drafted)_ | v1 S18 Therapeutic Framework | CBT + Mindfulness MVP; therapeutic annotation layer; opt-in; frequency-capped technique injection |
| S62 _(spec not yet drafted)_ | v1 S20 Story Sharing | PDF/ePub/web export from MemoryRecords; GDPR-safe; unlisted-by-default web stories |
| S63 _(spec not yet drafted)_ | v1 S22 Community | User-generated world templates; automated + human moderation pipeline; attribution |
